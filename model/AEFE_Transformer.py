...
class Transformer(Module):
    ...
    def __init__(self, d_model: int = 512, nhead: int = 8, num_encoder_layers: int = 6,
        ...
        if custom_decoder is not None:
            ...
            decoder_layer_1 = TransformerDecoderLayer(d_model, nhead, dim_feedforward, dropout, activation)
            ...
            self.decoder_1 = TransformerDecoder(decoder_layer_1, num_decoder_layers, decoder_norm)
            #self.decoder_2 = TransformerDecoder(decoder_layer_2, num_decoder_layers, decoder_norm)
    ...
    def forward(self, src: Tensor, tgt1: Tensor, src_mask: Optional[Tensor] = None,
        ...
        #output_2 = self.decoder_2(tgt2, memory, tgt_mask=tgt_mask, memory_mask=memory_mask,
        #                      tgt_key_padding_mask=tgt_key_padding_mask,
        #                      memory_key_padding_mask=memory_key_padding_mask)
