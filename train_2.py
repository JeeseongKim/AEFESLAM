...
def train():
    ...
    if os.path.exists("./SaveModelCKPT/train_model.pth"):
        ...
        model_detection_map_f.module.load_state_dict(checkpoint['model_detection_map_f'])
        ...
        optimizer_reconDetectionf.load_state_dict(checkpoint['optimizer_reconDetectionf'])
    ...
    for epoch in tqdm(range(num_epochs)):
            ...
            if (((epoch + 1) % 5 == 0) or (epoch == 0) or (epoch + 1 == num_epochs)):
                ...
                if (epoch != 0):
                    torch.save({
                        ...
                        'model_detection_map_f': model_detection_map_f.module.state_dict(),
                        ...
                        'optimizer_reconDetectionf': optimizer_reconDetectionf.state_dict(),
        ...
        saveLossData = 'epoch\t{}\tAll_Loss\t{:.4f} \tRecon\t{:.4f} \tCosim\t{:.4f}Sep\t{:.4f} \tTrans\t{:.4f} \tDk\n'.format(epoch, running_loss, running_recon_loss, running_cosim_loss, running_sep_loss, running_transf_loss,running_detection_loss)
