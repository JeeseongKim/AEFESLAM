...
def train():
    ...
    model_StackedHourglassForKP = StackedHourglassForKP(nstack=num_nstack, inp_dim=128, oup_dim=64, bn=False,increase=0).cuda()
    ...
    model_DETR_kp = DETR_1E1D(num_voters=voters, hidden_dim=256, nheads=8, num_encoder_layers=6, num_decoder_layers=6).cuda()
